...
//go:generate minimock -i github.com/Snake1-1eyes/vk_task_marketplace/internal/auth.Repository -o repository_mock.go -n RepositoryMock -p mocks
...
type RepositoryMock struct {
	...
	funcCreateUser          func(ctx context.Context, user *entity.User) (up1 *entity.User, err error)
	funcCreateUserOrigin    string
	inspectFuncCreateUser   func(ctx context.Context, user *entity.User)
	afterCreateUserCounter  uint64
	beforeCreateUserCounter uint64
	CreateUserMock          mRepositoryMockCreateUser

	funcGetUserByID          func(ctx context.Context, id uint64) (up1 *entity.User, err error)
	funcGetUserByIDOrigin    string
	inspectFuncGetUserByID   func(ctx context.Context, id uint64)
	afterGetUserByIDCounter  uint64
	beforeGetUserByIDCounter uint64
	GetUserByIDMock          mRepositoryMockGetUserByID

	funcGetUserByUsername          func(ctx context.Context, username string) (up1 *entity.User, err error)
...
func (mmCreateUser *mRepositoryMockCreateUser) Expect(ctx context.Context, user *entity.User) *mRepositoryMockCreateUser {
...
func (mmCreateUser *mRepositoryMockCreateUser) ExpectUserParam2(user *entity.User) *mRepositoryMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("RepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mRepositoryMockCreateUser) Inspect(f func(ctx context.Context, user *entity.User)) *mRepositoryMockCreateUser {
...
func (mmCreateUser *mRepositoryMockCreateUser) Return(up1 *entity.User, err error) *RepositoryMock {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("RepositoryMock.CreateUser mock is already set by Set")
	}
	...
	mmCreateUser.defaultExpectation.results = &RepositoryMockCreateUserResults{up1, err}
...
func (mmCreateUser *mRepositoryMockCreateUser) Set(f func(ctx context.Context, user *entity.User) (up1 *entity.User, err error)) *RepositoryMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mRepositoryMockCreateUser) When(ctx context.Context, user *entity.User) *RepositoryMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("RepositoryMock.CreateUser mock is already set by Set")
	}
...
func (e *RepositoryMockCreateUserExpectation) Then(up1 *entity.User, err error) *RepositoryMock {
	e.results = &RepositoryMockCreateUserResults{up1, err}
	return e.mock
}
...
// CreateUser implements mm_auth.Repository
func (mmCreateUser *RepositoryMock) CreateUser(ctx context.Context, user *entity.User) (up1 *entity.User, err error) {
...
func (mmGetUserByID *mRepositoryMockGetUserByID) Expect(ctx context.Context, id uint64) *mRepositoryMockGetUserByID {
...
func (mmGetUserByID *mRepositoryMockGetUserByID) ExpectIdParam2(id uint64) *mRepositoryMockGetUserByID {
	if mmGetUserByID.mock.funcGetUserByID != nil {
		mmGetUserByID.mock.t.Fatalf("RepositoryMock.GetUserByID mock is already set by Set")
	}
...
func (mmGetUserByID *mRepositoryMockGetUserByID) Inspect(f func(ctx context.Context, id uint64)) *mRepositoryMockGetUserByID {
...
func (mmGetUserByID *mRepositoryMockGetUserByID) Return(up1 *entity.User, err error) *RepositoryMock {
	if mmGetUserByID.mock.funcGetUserByID != nil {
		mmGetUserByID.mock.t.Fatalf("RepositoryMock.GetUserByID mock is already set by Set")
	}
...
func (mmGetUserByID *mRepositoryMockGetUserByID) Set(f func(ctx context.Context, id uint64) (up1 *entity.User, err error)) *RepositoryMock {
	if mmGetUserByID.defaultExpectation != nil {
...
// Then helper
func (mmGetUserByID *mRepositoryMockGetUserByID) When(ctx context.Context, id uint64) *RepositoryMockGetUserByIDExpectation {
	if mmGetUserByID.mock.funcGetUserByID != nil {
		mmGetUserByID.mock.t.Fatalf("RepositoryMock.GetUserByID mock is already set by Set")
	}
...
func (e *RepositoryMockGetUserByIDExpectation) Then(up1 *entity.User, err error) *RepositoryMock {
...
// GetUserByID implements mm_auth.Repository
func (mmGetUserByID *RepositoryMock) GetUserByID(ctx context.Context, id uint64) (up1 *entity.User, err error) {
...
func (mmGetUserByUsername *mRepositoryMockGetUserByUsername) Return(up1 *entity.User, err error) *RepositoryMock {
	if mmGetUserByUsername.mock.funcGetUserByUsername != nil {
		mmGetUserByUsername.mock.t.Fatalf("RepositoryMock.GetUserByUsername mock is already set by Set")
	}
...
func (mmGetUserByUsername *mRepositoryMockGetUserByUsername) Set(f func(ctx context.Context, username string) (up1 *entity.User, err error)) *RepositoryMock {
	if mmGetUserByUsername.defaultExpectation != nil {
...
func (e *RepositoryMockGetUserByUsernameExpectation) Then(up1 *entity.User, err error) *RepositoryMock {
...
// GetUserByUsername implements mm_auth.Repository
func (mmGetUserByUsername *RepositoryMock) GetUserByUsername(ctx context.Context, username string) (up1 *entity.User, err error) {
